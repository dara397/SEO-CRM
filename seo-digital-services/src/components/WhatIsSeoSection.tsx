        ...
        <div className="bg-[#231e1a] text-white rounded-3xl p-8 sm:p-12 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">
              Ready to dominant your industry's search engine rankings?
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-stone-300 pt-2">
              ...
              <span>•</span>
              <a href="mailto:rpdgwholesale@gmail.com" className="font-semibold text-stone-200 hover:underline flex items-center gap-1.5">
                <Mail className="w-4 h-4 text-[#e0b589]" /> rpdgwholesale@gmail.com
              </a>
            </div>
          </div>
