...
import { Globe, MapPin, Cpu, Link, ShoppingCart, Sparkles, ShieldCheck, CheckCircle2, MessageSquare, BarChart2, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-3xl mx-auto">
            Discover our <strong className="text-stone-900">SEO services</strong> built for sustainable Google search ranking, high-converting organic traffic, technical site health, and long-term domain authority.
          </p>

          {/* Volume-Weighted Keywords Banner Bar */}
        ...
        {/* Analytics Dashboard Feature Section */}
        <div className="bg-white border border-[#e8e2d8] rounded-3xl p-6 sm:p-10 shadow-md space-y-8">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-stone-100 pb-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-stone-600 mt-1">
                Every client receives access to our real-time SEO dashboard. Select any key metric below to see its business importance and how our SEO services optimize it.
              </p>
            </div>
          ...
          {/* Analytics Dashboard Image Showcase with Callouts */}
          <div className="relative rounded-2xl overflow-hidden border border-[#e8e2d8] shadow-lg group bg-stone-900">
            <img
              src={dashboardImg}
              alt="SEO analytics dashboard showing organic traffic of 25.4K and related organic performance metrics"
            ...
            <div className="absolute bottom-4 right-4 bg-stone-900/90 text-white p-3 rounded-xl backdrop-blur-md border border-stone-700 max-w-xs space-y-1 shadow-md hidden sm:block">
              ...
              <div className="text-[11px] text-stone-300">0 Critical errors &bull; Full Core Web Vitals speed</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-stone-600">
                Choose a specialized service module or opt for a complete managed campaign.
              </p>
            </div>

            <button
              type="button"
              onClick={() => onOpenReachOut('Managed Campaign Enquiry')}
            ...
            >
              <MessageSquare className="w-4 h-4" />
              <span>Discuss a Managed Campaign</span>
            </button>
          </div>
          ...
          <div className="bg-[#f2e7d8] border border-[#e2d2bd] p-2 rounded-2xl flex flex-wrap gap-1.5">
            {categories.map((cat) => (
              <button
                ...
                aria-pressed={selectedServiceCategory === cat}
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="bg-[#faf8f5] p-3 rounded-xl border border-[#e8e2d8] text-xs text-stone-700">
                    <strong className="text-stone-900 font-bold block mb-0.5">Typical Impact:</strong>
        ...
        <div className="bg-[#231e1a] text-white rounded-3xl p-8 sm:p-12 shadow-xl flex flex-col lg:flex-row justify-between items-center gap-8">
          <div className="space-y-3 max-w-2xl text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">
              Need a tailored SEO plan for your specific domain?
            </h2>
            <p className="text-xs sm:text-sm text-stone-300 leading-relaxed">
              Our organic search specialists run a complimentary website audit and present a six-month strategy tailored to your industry.
            </p>
          </div>
