...
import { ArrowRight, Sparkles, HelpCircle, ShieldCheck, CheckCircle2, TrendingUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <p className="text-base sm:text-lg text-stone-600 max-w-xl leading-relaxed">
              Accelerate organic traffic through high-intent keyword clustering, technical audits, and high-authority link building.
            </p>
            ...
            <div className="bg-white border border-[#e8e2d8] rounded-3xl p-6 sm:p-7 shadow-lg space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-stone-100 pb-4">
                <div>
                  ...
                  <div className="text-lg font-black text-stone-900">Sample Campaign Snapshot</div>
                </div>
              ...
              <p className="text-[10px] text-stone-500 leading-relaxed">
                Illustrative figures from an anonymised engagement. Individual results vary and are not guaranteed.
              </p>
