        ...
        <div className="bg-[#1b2730] text-white rounded-3xl p-8 sm:p-12 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-stone-300 leading-relaxed max-w-2xl">
              Our service packages provide transparent monthly pricing, a minimum 6-month commitment, one-time setup fee from $1,500, unlimited keyword research, and full technical audits.
            </p>
